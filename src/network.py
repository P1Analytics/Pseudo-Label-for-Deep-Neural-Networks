...
class Network(object):
    def __init__(self, sizes):
        ...
        For example,
        if the list was [2, 3, 1] then it would be a three-layer network,
...
if __name__ == "__main__":
    ...
    net.SGD(training_data, 4, 15, 3.0, test_data=test_data)
